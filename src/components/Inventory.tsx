                ...
                <td className="px-3 py-2 text-right">
                  <div className="flex justify-end gap-4">
                    {p.source === 'MASTER' ? (
                      ...
                      <>
                        <button onClick={() => onEdit(p)} className="text-[#5a4fcf] hover:text-[#4a3fb5] flex items-center gap-1">
                          <Edit2 className="w-4 h-4" /> Edit
                        </button>
                        <button onClick={() => onDelete(p.id)} className="text-red-600 hover:text-red-900 flex items-center gap-1">
