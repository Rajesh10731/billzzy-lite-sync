...
export function BottomNavBar() {
  ...
  return (
    <nav className="bg-[#5a4fcf] z-30 h-[calc(5rem+env(safe-area-inset-bottom))] pb-[env(safe-area-inset-bottom)] flex items-center justify-between px-3 shadow-[0_-2px_8px_rgba(0,0,0,0.2)] rounded-t-2xl lg:hidden relative">
      {/* Left two items */}
